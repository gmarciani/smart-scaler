...
class MainScheduler(BackgroundScheduler):
    ...
    def __init__(self, kubernetes_conn, repo_manager_conn, agents, kubernetes_pull):
        ...
        :param kubernetes_conn: (SimpleConnection) the Kubernetes connection (host,port).
        :param repo_manager_conn: (SimpleConnection) the Kubernetes connection (host,port).
    ...
    def start(self):
        ...
        self.add_job(id="main_loop", func=main_loop,
